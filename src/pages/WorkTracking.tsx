      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mx-auto max-w-4xl space-y-8">
          <div className="text-center space-y-2">
            <h1 className="text-3xl font-bold text-foreground md:text-4xl">Suivi des Travaux Scolaire</h1>
            <p className="text-muted-foreground">Suivez votre progression académique</p>
          </div>
